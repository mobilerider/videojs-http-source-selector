 ...
 * @version 1.1.6
 * @copyright 2025 Justin Fujita <Justin@pivotshare.com>
 * @license MIT
 */
(function (global, factory) {
  ...
  var SourceMenuButton = /*#__PURE__*/function (_MenuButton) {
    function SourceMenuButton(player, options) {
      ...
      _this.player().qualityLevels().on(['change', 'addqualitylevel'], videojs.bind(_this, _this.update));
      return _this;
    }
    ...
    _proto.buildCSSClass = function buildCSSClass() {
      return _MenuButton.prototype.buildCSSClass.call(this) + ' vjs-icon-cog';
    };
    _proto.update = function update() {
      return _MenuButton.prototype.update.call(this);
    };
